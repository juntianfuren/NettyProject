...
//	    String body = new String(req, "UTF-8").substring(0, req.length - System.getProperty("line.separator").length()); // 通过 new String 构造函数获取请求信息。
	    System.out.println("The time server receive ordeer : " + body + "; this counter is : " + ++counter); // 打印请求信息
